...
número de la fecha en la que se tocará próximamente (actual).***(NO ENTENDI)*****
...
lo hace cualquier recital. *******(SIN HACER)****
...
public class recitalesMain {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
       EventoOcasional eventoO;
       Gira gira; String tema;
       Fecha fecha1,fecha2;
       fecha1 = new Fecha("la plata",2);
       fecha2 = new Fecha("gonet ",1);
       gira = new Gira("banda1",3,"gira1",2);
