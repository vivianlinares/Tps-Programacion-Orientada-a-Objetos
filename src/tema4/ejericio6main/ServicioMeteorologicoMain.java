...
public class ServicioMeteorologicoMain {
    ...
    public static void main(String[] args) {
        ...
        SistemaAnio sistema1; double temperatura;
        Estacion estacion = new Estacion(" la plata ","-34.921","57.955");
        sistema1 = new SistemaAnio(estacion,2021,3);
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 12; j++) {
                temperatura =GeneradorAleatorio.generarDouble(30);
                sistema1.registro(j, i, temperatura);
