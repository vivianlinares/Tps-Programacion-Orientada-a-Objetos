...
public class Demo01ConstructoresLibro {
    ...
    public static void main(String[] args) {
        ...
        autor.setBiografia("sdfkjdf.");autor.setNombre("Herbert Schildt");autor.setOrigen("algun pais");
        
        Libro libro1= new  Libro( "Java: A Beginner's Guide",   
                                 "Mcgraw-Hill", 2014, autor,  
                                 "978-0071809252", 21.72);
        Autor autor2 = new Autor();
        autor2.setBiografia("dgdfglk");autor2.setNombre("John Horton"); autor2.setOrigen("algun otro pais");
